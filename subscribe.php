...
<script>
  (function() {
    var cx = '016656741306535874023:w4qxjm2ojag';
...
<div class="j-header">
  <div class="name">
    <h1>International Journal of Theoretical and Applied Nanotechnology (IJTAN)<br><p class="body">ISSN: 1929-1248</p></h1>
    <div class="oalink">
    ...
    <img src="../img/journals/j-ijtan.jpg" class="j-img">
</div>
</div>

<div class="desktop jhead">
  <div class="name">
    <h1>International Journal of Theoretical and Applied Nanotechnology (IJTAN)</h1>
    <div class="issn">
    <p class="body">ISSN: 1929-1248</p>
    <div class="oalink">
    <a href="http://avestia.com/openaccess" target="blank" title="Avestia's Open Access">
          <img src="../img/j-oa.png" border="0" onmouseover="this.src='../img/j-oa-hover.png'" onmouseout="this.src='../img/j-oa.png'" class="j-oa">
    </a>
  ...
  <div class="navbar-collapse collapse">
    <ul class="nav navbar-nav">
      ...
      <li><a href="../volume1/issue2.html">Volume 1, Issue 2</a>
...
$confirmed = 0;
 ...
 // now we insert it into the database
  ...
  $subject = "International Journal of Theoretical and Applied Nanotechnology (IJTAN)"; 
  $message = "Thank you for signing up to receive alerts for IJTAN - International Journal of Theoretical and Applied Nanotechnology.
...
<div class="desktop jhead">
  ...
  <div class="main-content j-home">
    ...
    <p class="body">Thank you for subscribing to IJTAN - International Journal of Theoretical and Applied Nanotechnology. A confirmation email has been sent to your email. Please click on the confirmation link available in the email to confirm your subscription.</p>
